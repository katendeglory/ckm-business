window.CKM_CONFIG = {
  ...
  social: {
    ...
    linkedin: "https://linkedin.com/company/ckm",
    instagram: "https://instagram.com/ckm"
  },
  stats: [
    {
      value: 300,
  ...
  method: [
    ...
    },
    {
      ...
      description: {
        fr: "Positionnement dans notre pipeline avec matching intelligent des profils.",
        en: "Positioning in our pipeline with intelligent profile matching.",
        zh: "纳入项目库，智能匹配合适买家画像。"
      }
    },
    {
  ...
  whyChooseUs: [
    {
      ...
      description: {
        fr: "Cadre de travail rigoureux pour limiter les frictions et renforcer la confiance.",
        en: "Rigorous framework that reduces friction and builds confidence.",
        zh: "严谨的工作框架，减少摩擦、增强信任。"
      }
    },
    {
      icon: "network",
